...
//log that the module is loaded
    console.log(` :: ⬜️ Module: ${description.name} | Loaded version ${description.version} enhanced by Invalid`)
//voice state update event to check joining/leaving channels
  ...
  if (oldState.channelID && newState.channelID) {
    ...
    async function jointocreatechannel(user) {
      //log it 
      client.channels.cache.get(`713445768983216159`).send("Ένας <@&792523288832114708> ή <@&792524281661358111> να εξυπηρετήσει τον/την " + user.member.user.username + "#" + user.member.user.discriminator + " στο 📞𝐖𝐚𝐢𝐭𝐢𝐧𝐠 𝐟𝐨𝐫 𝐒𝐮𝐩𝐩𝐨𝐫𝐭")
      ...
      await user.guild.channels.create(`📞𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐑𝐨𝐨𝐦`, {
        type: 'voice',
        parent: "713446037259288588", //or set it as a category id
      }).then(async vc => {
